...
$bookCount = $bookHandler->getBookByNameCount($bookName);
...
$books = $bookHandler->getPaginatedBooksbyName($sessionId, $size, $page, $bookName);
...
if($books === null){
    ...
    echo $responseBuilder->setName("getpaginatedbooksbyname")
    ->setStatus("failed")

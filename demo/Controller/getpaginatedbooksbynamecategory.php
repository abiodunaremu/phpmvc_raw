...
$bookCount = $bookHandler->getBookByNameCategoryCount($bookName, $category);
...
$books = $bookHandler->getPaginatedBooksbyNameCategory($sessionId, $size, $page, $bookName, $category);
...
if($books === null){
    ...
    echo $responseBuilder->setName("getpaginatedbooksbynamecategory")
    ->setStatus("failed")
...
foreach($books as $book){
    ...
    $responseData->addValue("pagename",$bookName);

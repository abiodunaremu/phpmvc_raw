...
<head>
    ...
    <title>YourBooks API - Root Address</title>
...
<body>
    <div class="container">
        <h1>
        YourBooks Backend API Root
        </h1>    
        This is the root page for YourBooks Backend Application Programming Interface.
        <br/>
        Click <a href='documentation'>here</a> for documentation
    </div>
</body>
</html>
